...
if (window.isc && isc.version != "v12.1p_2021-01-06/Pro Deployment" && !isc.DevUtil) {
    isc.logWarn("SmartClient module version mismatch detected: This application is loading the core module from "
        + "SmartClient version '" + isc.version + "' and additional modules from 'v12.1p_2021-01-06/Pro Deployment'. Mixing resources from different "
...
,isc.A.getChartHeight=function isc_FacetChart_getChartHeight(recalc){
    var chartHeight=this.getInnerContentHeight()
        -this.getChartTop()
...
isc.evalBoundary;isc.B.push(isc.A.changeValueAxisPositions=function isc_FacetChart_changeValueAxisPositions(indexMap){
    if(!this._hasExtraAxes()){
        return;
    }
    var settings=this._getExtraAxisSettings();
